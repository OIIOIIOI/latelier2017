...
function atelier_setup() {
	 ...
	 * If you're building a theme based on atelier, use a find and replace
	 * to change 'atelier' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'atelier' ),
	) );
...
function atelier_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'atelier_content_width', 640 );
}
...
function atelier_scripts() {
    ...
    wp_enqueue_script( 'atelier-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'atelier-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
